		...
		// skelJS (probably don't need to change anything here unless you know what you're doing)
			skelJS: {
				...
				breakpoints: {
					...
					'wide':	{ range: '661-1880', containers: 1200, grid: { gutters: 40 } },
					'normal':	{ range: '661-1620', containers: 660, grid: { gutters: 40 } },
					'narrow':	{ range: '661-1320', containers: 'fluid', grid: { gutters: 20 } },
					'narrower':	{ range: '-660', containers: 'fluid', grid: { gutters: 15 } },
