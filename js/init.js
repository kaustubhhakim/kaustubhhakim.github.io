	...
	var prologue_settings = {
		...
		// skelJS (probably don't need to change anything here unless you know what you're doing)
			skelJS: {
				...
				useOrientation: true,
				breakpoints: {
					'widest':	{ range: '1881-', hasStyleSheet: false, containers: 1400, grid: { gutters: 20 } },
					'wide':	{ range: '961-1880', containers: 1200, grid: { gutters: 20 } },
					'normal':	{ range: '961-1620', containers: 960, grid: { gutters: 20 } },
